...
const fetchPostulationDetailsPourEtudiant = async() =>  {
    ...
    try{
        ...
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/v1/etudiants/postulations`,{
...
export default fetchPostulationDetailsPourEtudiant;
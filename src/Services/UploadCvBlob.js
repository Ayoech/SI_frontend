...
const UploadCvBlob = async (file) => {
    ...
    try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/v1/etudiants/uploadCVBlob`, formData, {
            headers: {

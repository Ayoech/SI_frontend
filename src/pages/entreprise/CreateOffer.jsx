      ...
      <div className={`flex justify-center items-start   ${openSidebarToggle ? 'ml-[56rem] mt-[4rem] pt-[0.1rem]' : 'ml-[16rem]'}`}>
        <div className=' rounded-lg p-24  max-w-6xl'>
          <form onSubmit={handleSubmit}>
            ...
            <div className='mb-4'>
              <label htmlFor='num_entreprise' className='block font-medium' style={{width: '200px'}}>Company Number</label>
              <input
                type='text'
                name='num_entreprise'
                id='num_entreprise'
            ...
            <div className='mb-4'>
              <label htmlFor='num_professeur' className='block font-medium' style={{width: '200px'}}>Professor Number</label>
              <input
                type='text'
                name='num_professeur'
                id='num_professeur'
            ...
            <div className='mb-2'>
              <label htmlFor='num_tuteur' className='block font-medium' style={{width: '200px'}}>Supervisor Number</label>
              <input
                type='text'
                name='num_tuteur'
                id='num_tuteur'
